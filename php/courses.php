...
<body>
  ...
  <div class="w3-bar w3-purple w3-padding-16" id="navBar">
    ...
    <div class="w3-right">
      <a href="logout.php" class="w3-bar-item w3-button w3-hide-small">LOGOUT <i class="fa fa-sign-out" style="font-size:24px; color:rgb(255, 255, 255)"></i></a>
    </div>

    <a href="javascript:void(0)" class="w3-bar-item w3-button w3-right w3-hide-large w3-hide-medium" onclick="servicecardMenu()">
      <i class="fa fa-bars"></i>
    </a>
  </div>

  <!-- servicecard menu -->
  <div id="idMenuBar" class="w3-bar-block w3-card w3-white w3-hide w3-hide-large w3-hide-medium">
    ...
    <a href="logout.php" class="w3-bar-item w3-button w3-center">Logout</a>
  </div>
  ...
  <div class="w3-content" style="max-width: 1200px">
    <div class="w3-center">
      <h1 style="font-family:courier;"><i><b> Meaningful Learning
            Starts Here</b></i></h1>
      <div class="w3-grid-template w3-padding w3-animate-bottom">
        ...
        foreach ($rows as $courses) {
          ...
          echo <<<END
              ...
              <br>
              <div class='w3-content w3-container w3-purple w3-padding-70 w3-round w3-center' style='height: 90px'>
              <h5>$subname</h5>
              </div>
              <img src='../assets/courses/$subid.png' alt='' class='fitImg' style='width:100%;'>
              
              <p>Tutor : <img src='../assets/tutors/$tutorid.jpg' alt='' class='roundedImage'></p>
              <h6><i class='fa fa-star' style="font-size:20px; color:orange;"></i>  $subrating / 5.0</h6> 
